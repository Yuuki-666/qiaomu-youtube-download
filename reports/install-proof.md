...
- 发布流程：feature branch → PR #1/#3 → squash merge 到 `main`
...
- v1.1.0 GitHub 干净安装复验：4/4 单测、包校验、`doctor --upgrade`、公开 Shorts 下载与 ffprobe 均通过
- v1.2.0 GitHub `main` 干净安装复验：10/10 单测、包校验、长视频进度输出、最终文件筛选和 ffprobe 均通过
...
- v1.2.0：10/10 单元测试、包校验和 Meta Skill 校验通过
